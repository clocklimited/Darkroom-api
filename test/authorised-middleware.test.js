var config = require('con.figure')(require('./config')())
  ...
  , createAuthorisedMiddleware = require('../lib/authorised')
  , authorised = createAuthorisedMiddleware(config)
  , imgSrcId = 'b063889dedaee7dae61b8f2dbcf3f962'
...
describe('Authorised middleware', function() {
  ...
  it('should return true for an authorised URL with unknown querystrings', function (done) {
    ...
    request(server)
      .get(url + '?' + querystring.stringify({ a: 1, b: 2, utm_source: 'test', utm_campaign: 'test' }))
      .expect(200)
      .end(done)
  })
  ...
  it('should return true for an authorised URL with acceptable querystrings', function (done) {
    var qsObject = { x0: '100', y0: '100', x1: '0', y1: '0', height: '100', width: '100', colour: '#fff' }
